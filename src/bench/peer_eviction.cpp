...
BENCHMARK(EvictionProtection0Networks250Candidates, benchmark::HIGH);

// 1 disadvantaged network (Tor) with 250 eviction candidates.
BENCHMARK(EvictionProtection1Networks250Candidates, benchmark::HIGH);

// 2 disadvantaged networks (I2P, Tor) with 250 eviction candidates.
BENCHMARK(EvictionProtection2Networks250Candidates, benchmark::HIGH);

// 3 disadvantaged networks (I2P/localhost/Tor) with 50/100/250 eviction candidates.
BENCHMARK(EvictionProtection3Networks050Candidates, benchmark::HIGH);
BENCHMARK(EvictionProtection3Networks100Candidates, benchmark::HIGH);
BENCHMARK(EvictionProtection3Networks250Candidates, benchmark::HIGH);
