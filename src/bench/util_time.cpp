...
BENCHMARK(BenchTimeDeprecated, benchmark::HIGH);
BENCHMARK(BenchTimeMillis, benchmark::HIGH);
BENCHMARK(BenchTimeMillisSys, benchmark::HIGH);
BENCHMARK(BenchTimeMock, benchmark::HIGH);
