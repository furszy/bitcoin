...
BENCHMARK(WalletBalanceDirty, benchmark::HIGH);
BENCHMARK(WalletBalanceClean, benchmark::HIGH);
BENCHMARK(WalletBalanceMine, benchmark::HIGH);
BENCHMARK(WalletBalanceWatch, benchmark::HIGH);
