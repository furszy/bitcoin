 ...
 */
CallResult<CreatedTransactionResult> CreateTransaction(CWallet& wallet, const std::vector<CRecipient>& vecSend, int change_pos, const CCoinControl& coin_control, FeeCalculation& fee_calc_out, bool sign = true);
