...
BOOST_FIXTURE_TEST_CASE(wallet_sync_db_fail_invalid_state_test, TestingSetup)
{
    ...
    // 2) Verify that available balance of this new tx and the old one is updated (prev tx is marked dirty)
